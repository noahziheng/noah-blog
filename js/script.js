(function ($) {
  ...
  tipEl.innerHTML = '<span>您正在访问的是 <a href="https://noahziheng.github.io/blog">Noah\'s Blog</a> 的存档，我的个人页已经迁往 <a href="https://noahziheng.github.io/blog">这里</a></span><i class="icon-close" />'
  ...
  document.querySelector('.archive-tip > .icon-close').addEventListener('click', function (e) { 
    e.preventDefault()
    e.stopPropagation()
    document.querySelector('.archive-tip').style.display = 'none'
   })
})(jQuery)
